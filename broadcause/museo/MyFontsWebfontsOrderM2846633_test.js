...
woff = path + "/webfonts/woff/style_159303.woff";
if (http) {
...
//test for eot
eot = path + "/webfonts/eot/style_159303.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for svg
svg = path + "/webfonts/svg/style_159303.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for css
css = path + "/webfonts/datacss/MyFontsWebfontsOrderM2846633.css";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
woff = path + "/webfonts/woff/style_159309.woff";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('Woff_result','error',"WOFF File: " +woff+ " is inaccessable.  Check the file permissions and the MIME types");
//test for eot
eot = path + "/webfonts/eot/style_159309.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('eot_result','error',"EOT File: " +eot+" is inaccessable.  Check the file permissions and the MIME types");
//test for svg
svg = path + "/webfonts/svg/style_159309.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
